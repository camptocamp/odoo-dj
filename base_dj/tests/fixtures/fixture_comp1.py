...
def load_res_company(ctx):
    ...
    path = 'data/install/generated/dj_test/comp1/res.company.csv'
...
def load_res_users(ctx):
    ...
    path = 'data/install/generated/dj_test/comp1/res.users.csv'
...
def load_res_partner(ctx):
    ...
    path = 'data/install/generated/dj_test/comp1/res.partner.csv'
